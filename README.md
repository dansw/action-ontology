...
models/
  ...
  ontology-lora-v8/           # current default adapter -- v7's data plus 72 more
...
With the tuned LoRA adapter (`models/ontology-lora-v8`, the current default --
...
(854 total). `ontology-lora-v8` is the current default.
